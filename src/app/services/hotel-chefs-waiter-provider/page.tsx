    ...
    <main className="min-h-screen bg-white font-sans text-center selection:bg-blue-600 selection:text-white">
      ...
      <section className="pt-32 sm:pt-40 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <h1 className="text-[42px] sm:text-[56px] font-black text-[#0f172a] leading-[1.1] mb-6 tracking-tight max-w-4xl mx-auto">
          Trusted Hotel Chefs & Waiters Provider in India
        </h1>
      ...
      <section id="salary-guide" className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-t border-slate-100">
         <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-10 text-left">
               {/* Box 1: Kitchen Staff */}
               <div className="bg-white rounded-[24px] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.06)] overflow-hidden">
                  <div className="bg-[#004bb4] px-6 sm:px-8 py-5">
                     <h3 className="text-white font-extrabold text-[18px] sm:text-[20px] flex items-center gap-2">
                       <span>👨‍🍳</span> Kitchen Staff
                     </h3>
                     <p className="text-blue-100 text-[13px] font-medium mt-1">Chef Department</p>
                  </div>
                  <div className="divide-y divide-slate-100 px-6 sm:px-8 py-2">
                    {[
                      ...
                      { role: 'Commi 2', pay: '₹14K - ₹18K' }
                       ...
                       <div key={idx} className="flex justify-between items-center py-4">
                         <span className="text-[#334155] font-medium text-[15px]">{item.role}</span>
                         <span className="text-[#004bb4] font-bold text-[15px] tracking-wide">{item.pay}</span>
                       </div>
                    ))}
                  </div>
               </div>
               ...
               {/* Box 2: Service Staff */}
               <div className="bg-white rounded-[24px] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.06)] overflow-hidden">
                  <div className="bg-[#ef4444] px-6 sm:px-8 py-5">
                     <h3 className="text-white font-extrabold text-[18px] sm:text-[20px] flex items-center gap-2">
                       <span>🍽️</span> Service Staff
                     </h3>
                     <p className="text-red-100 text-[13px] font-medium mt-1">Front Office & Restaurant</p>
                  </div>
                  <div className="divide-y divide-slate-100 px-6 sm:px-8 py-2">
                    {[
                      ...
                      { role: 'Steward / Waiter', pay: '₹10K - ₹18K' }
                       ...
                       <div key={idx} className="flex justify-between items-center py-4 text-[15px]">
                         <span className="text-[#334155] font-medium">{item.role}</span>
                         <span className="text-[#ef4444] font-bold tracking-wide">{item.pay}</span>
                       </div>
                    ))}
                  </div>
               </div>
            ...
            {/* Important Note */}
            <div className="bg-white border text-left border-slate-200 border-l-[3px] border-l-[#004bb4] rounded-r-xl rounded-l-sm p-6 sm:p-8 shadow-[0_2px_15px_rgba(0,0,0,0.03)] mx-auto max-w-2xl">
               <p className="text-[14px] text-[#64748b] leading-relaxed">
                 <strong className="text-[#0f172a] font-bold">Important Note:</strong> Salary may vary depending on experience, city, accommodation facilities, skill level and job responsibilities.
               </p>
            </div>
         </div>
      </section>

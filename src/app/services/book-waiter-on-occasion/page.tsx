        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              { icon: '👨‍👩‍👧‍👦', lbl: "Family Get-Togethers" },
              { icon: '🪔', lbl: "Festival Celebrations" },
              { icon: '🔑', lbl: "Housewarming Parties" },
              { icon: '🍽️', lbl: "Special Dinner Events", active: true },
            ].map((item, idx) => (
              <div 
                key={idx} 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 bg-[#fff7ed] rounded-xl py-6 px-6 text-center max-w-4xl mx-auto border border-orange-100">
             ...
             <p className="text-[#ea580c] font-medium text-[14px] sm:text-[15px] max-w-2xl mx-auto">
               Our waiters can serve seamlessly for dishes and fully customize the menu according to your event type, guest count, dietary preferences, and budget.
             </p>
          </div>
        </div>
      </section>

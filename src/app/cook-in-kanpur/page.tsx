...
export default function CookInKanpurPage() {
  const city = "Kanpur";
         ...
         <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8">
             <div className="w-full lg:w-1/2 text-center lg:text-left">
                <h1 className="text-[38px] sm:text-[46px] lg:text-[56px] font-bold text-slate-900 leading-[1.15] mb-6">
                    Hire The Perfect <br/> <span className="text-[#1b71f2]">Cook In Kanpur</span>
                </h1>
      ...
      <div id="booking-form" className="py-24 px-4">
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="flex flex-col justify-center h-full lg:pr-10 text-center lg:text-left">
                 <h2 className="text-[34px] md:text-[40px] font-bold text-slate-900 mb-6 leading-tight">Trust the best Cooks<br/>in Kanpur</h2>

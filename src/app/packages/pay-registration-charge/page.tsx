...
export default function PayRegistrationChargePage() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans overflow-x-hidden selection:bg-blue-200">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative bg-[#0b519d] pt-24 pb-0 lg:pt-32 lg:pb-0 overflow-hidden flex items-end">
            ...
            <div className="flex justify-center lg:justify-end items-center h-full w-full relative pb-6 lg:pb-12 mt-2 sm:mt-0 lg:-mt-2">
              <div className="relative z-10 rounded-[20px] sm:rounded-[24px] p-1 sm:p-1.5 bg-white/5 backdrop-blur-3xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transform transition-transform duration-700 hover:scale-105 hover:-translate-y-2">
                <img 
                  ...
                  className="w-[200px] h-[270px] sm:w-[300px] sm:h-[380px] lg:w-[360px] lg:h-[440px] object-cover object-top rounded-[16px] sm:rounded-[20px]"
                />
              </div>
            </div>
          </div>

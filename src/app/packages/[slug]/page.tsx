  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-28 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-10">
        ...
        {/* Pill */}
        <div className="inline-flex items-center gap-2 bg-blue-100/50 border border-blue-200 text-blue-800 text-[11px] font-black uppercase tracking-widest px-4 py-2 rounded-full mb-6">
        ...
        {/* Content Box */}
        <div className="bg-white rounded-3xl p-10 sm:p-16 border-2 border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] relative overflow-hidden">
           ...
           <div className="mt-8 pt-8 border-t border-slate-100">
             <Link href="/" className="bg-[#004bb4] text-white font-bold py-3.5 px-8 rounded-xl shadow-md hover:-translate-y-1 hover:shadow-lg transition-all">
                Go Back to Home
             </Link>
           </div>
        </div>
